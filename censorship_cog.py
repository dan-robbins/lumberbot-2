...
class censorship_cog(commands.Cog):
    ...
    async def on_message(self, message: discord.Message):
        ...
        if self.regex1.search(message.content.lower()) is not None or self.regex2.search(message.content.lower()) is not None or self.regex3.search(message.content.lower()) is not None:
